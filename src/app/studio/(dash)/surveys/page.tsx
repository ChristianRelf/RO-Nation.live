...
import { deleteSurvey, setSurveyStatus } from "@/app/actions/studio";
  ...
  return (
    <div>
      <AdminHeader
        ...
        action={{ label: "+ New survey", href: "/studio/surveys/new" }}
      />
      ...
      {surveys.length ? (
          ...
          {surveys.map((s) => (
            <li key={s.id} className="card p-5">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-xs text-faint">
                    ...
                    <Link
                      href={`/studio/surveys/${s.id}/responses`}
              ...
              <div className="mt-4 flex flex-wrap items-center gap-4 border-t border-line pt-3 text-sm">
                ...
                <Link
                  href={`/studio/surveys/${s.id}/edit`}
                  className="text-muted hover:text-fg"
                >
                  Edit
                </Link>
                <a
                  href={`/api/studio/surveys/${s.id}/export`}
                  className="text-muted hover:text-fg"
                >
                  Export CSV
                </a>
        ...
        <div className="card grid place-items-center px-6 py-20 text-center">
          ...
          <Link href="/studio/surveys/new" className="btn btn-accent mt-5">
