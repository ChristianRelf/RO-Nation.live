...
// The unauthorised landing page for the Studio. It sits OUTSIDE the guarded
...
export default async function StudioAccessPage() {
  ...
  if (access.state === "allowed") redirect("/studio");
          ...
          {access.state === "anonymous" ? (
            <>
              ...
              <p className="mt-3 text-muted">
                Create events and write for the blog. Sign in with the Roblox
                account that holds your rank in the group.
              </p>
              <a
                href="/api/auth/roblox/login?returnTo=/studio"
                className="btn btn-accent mt-8 w-full"
              >
                Sign in with Roblox
              </a>
              <p className="mt-4 text-xs text-faint">
                Rank {env.studio.minRank} or above is required.
              </p>
            </>
          ) : (
            <>
              ...
              <div className="card mt-8 p-6 text-left">
                <p className="text-sm text-muted">
                  ...
                  , but the Studio is limited to group members ranked{" "}
                  <span className="font-semibold text-fg">
                    {env.studio.minRank}
                  </span>{" "}
                  or above.
