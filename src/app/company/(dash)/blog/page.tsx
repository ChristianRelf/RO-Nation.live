...
export default async function CompanyBlogPage() {
  await requireCompanyUser();
  // RNL's own. A partner's posts are edited in THEIR studio, not here.
  ...
  return (
    <div>
      <AdminHeader
        ...
        action={{ label: "+ New post", href: "/company/blog/new" }}
      />
      ...
      {posts.length ? (
        ...
        <div className="card grid place-items-center px-6 py-20 text-center">
          ...
          <Link href="/company/blog/new" className="btn btn-accent mt-5">
            Write the first one
          </Link>
        </div>
      )}
