...
import { deleteCareer } from "@/app/actions/company";
...
export default async function CompanyCareersPage() {
  ...
  // RNL's own roles. A partner's openings are managed in their studio.
  ...
  return (
    <div>
      <AdminHeader
        ...
        action={{ label: "+ New role", href: "/company/careers/new" }}
      />
      ...
      {careers.length ? (
                  ...
                  <tr key={c.id} className="hover:bg-fg/[0.02]">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center justify-end gap-3">
                        ...
                        <Link
                          href={`/company/careers/${c.id}/edit`}
                          className="text-muted hover:text-fg"
                        >
                          Edit
                        </Link>
        ...
        <div className="card grid place-items-center px-6 py-20 text-center">
          ...
          <Link href="/company/careers/new" className="btn btn-accent mt-5">
