...
const sections: LegalSection[] = [
  {
    ...
    list: [
      ...
      "merch.ronation.live - the shop, which is a showcase that hands off to Roblox. See our [Merch & Refunds](/legal/refunds) policy.",
      "authorise.ronation.live - the sign-in host. It exists only for the round trip out to Roblox and back.",
      "accounts.ronation.live and pay.ronation.live - the payment system: the documents we raise, and the statements a partner or contractor reads. How that works is set out in [Payments & Payouts](/legal/payments).",
  ...
  },
  {
    ...
    list: [
      ...
      "A Roblox permission grant, but only if you have given us one. Sign-in itself asks for nothing beyond your public profile. If you ever reach a paid checkout on a tier that is sold as a Roblox game pass, we ask separately for permission to check whether you own that pass - and if you agree, we store the access token, the refresh token and the list of permissions you actually granted, so we can make that one check. It can read nothing else, and it cannot spend, change or post anything.",
      "Purchase records, where a ticket was paid for on Roblox. That is Roblox's own purchase ID, the Robux the sale reported, and which Roblox place and product it happened in - the record that stops you being charged twice for the same thing.",
      "Accounting records, if we do business with you as a partner, contractor or supplier. The name we raise documents against, any note we keep about the arrangement, the Roblox accounts we have granted access to your statements, every document raised with you and what is on it, and the payment requests you send us. See [Payments & Payouts](/legal/payments).",
      "Enquiries and data requests you send us through a form, and whatever you type into one.",
  ...
  },
  {
    ...
    list: [
      ...
      "No card or bank details, ever. There is no checkout on any of our sites and no way to give us one. Everything here is Robux, and Robux moves through Roblox - so where a payment happens, Roblox takes it and we only ever see that it happened. That applies to a paid ticket and to a payout alike.",
      "No Robux balance. We cannot see how much Robux you have, and the permission a paid checkout asks for cannot spend any.",
      ...
      "No email address or date of birth from Roblox. Roblox does not hand us either, and we do not ask.",
    ],
  },
  {
    heading: "Cookies",
  ...
  },
  {
    ...
    list: [
      ...
      "Checking, once and only when you reach a paid checkout, that you own the Roblox game pass a tier is sold as - so a paid ticket can be issued to the person who actually bought it.",
      "Keeping the books: raising documents, paying partners and contractors what they are owed, matching payments to them, and keeping the record of it. We are obliged to keep accurate financial records, and we do.",
  ...
  },
  {
    ...
    list: [
      ...
      "Our accounting desk is company staff only. If we do business with you, the Roblox accounts you have told us about can see that entity's own documents and requests on pay.ronation.live - their own, and nobody else's.",
      "A document we send you has a private link. Anyone holding that link can read that one document, which is the point of it - it is how we send you something without making you sign in. Treat it like the document it is.",
  ...
  },
  {
    ...
    list: [
      ...
      "A Roblox permission grant - kept while it is useful for checking a pass you bought. You can revoke it from your Roblox account settings at any time, and asking us deletes the stored tokens.",
      "Accounting records and purchase records - kept as financial records for as long as we are required to, and long enough to settle a dispute about a payment. These are records of a transaction between us, so they are the one thing we cannot simply delete on request.",
  ...
  },
  {
    ...
    body: [
      ...
      "You can also withdraw the paid-checkout permission, if you ever gave us one, from your Roblox account settings - or ask us, and we delete the stored tokens.",
      "Three honest limits on deletion. We may keep a blacklist entry where removing it would put other people at risk - if you are on one, ask us to review it rather than to erase it. We cannot un-count an aggregate figure, such as the attendance of a show that has already happened, because that number no longer identifies anybody. And we cannot delete a financial record - a document raised with you, or the record of a payment - because it is a record of something that actually happened between us and we are obliged to keep it.",
  ...
  },
  {
    ...
    body: [
      ...
      "The one credential we do hold is the paid-checkout permission grant, where you have given us one. It is deliberately kept to a single read-only permission - it can ask Roblox whether you own a game pass, and nothing else. It cannot spend Robux, change your account, or post anything, so the worst it could do in the wrong hands is answer a question about a pass.",
