...
export default function SettingsPage() {
  ...
  -d '{"code":"RN-AB12CD"}'`}</Code>
      ...
      <Section title="Admin account">
        <Row label="Username" value={env.admin.username} />
        <Row label="Password" value="Set via the ADMIN_PASSWORD env var" />
        <p className="mt-2 text-sm text-muted">
          Change these in your <code className="font-mono text-fg">.env</code> and
