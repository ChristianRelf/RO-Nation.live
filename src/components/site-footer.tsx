...
// shows each platform's own logo rather than a hand-drawn lookalike. Only discord and roblox
// are ever guaranteed (see lib/site.ts); anything without a mark here carries a plain
// outward-arrow fallback, so adding an account is still one line in the record and needs no
// new artwork here - a mark is an upgrade, not a prerequisite.
